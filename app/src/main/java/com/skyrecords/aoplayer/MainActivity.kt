...
import com.skyrecords.aoplayer.databinding.ActivityMainBinding
import java.io.File
...
//            else ActivityCompat.requestPermissions(this, arrayOf(android.Manifest.permission.WRITE_EXTERNAL_STORAGE), 13)
    ...
    private fun fetchMusicFromFirestore() {
        ...
        db.collection("Songs")
            ...
            .addOnSuccessListener { result ->
                ...
                // Add online songs into the existing MusicListMA
                MusicListMA.addAll(onlineMusicList)
                musicAdapter.updateMusicList(MusicListMA)

                binding.totalSongs.text = "Total Songs : " + musicAdapter.itemCount
            }
            .addOnFailureListener { exception ->
                Toast.makeText(this, "Failed to load online songs: ${exception.message}", Toast.LENGTH_SHORT).show()
            }
    }
    ...
    private fun initializeLayout() {
        ...
        // For refreshing layout on swipe
